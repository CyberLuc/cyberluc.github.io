...
new_post_ext    = "karkdown"  # default new post file extension when using the new_post task
new_page_ext    = "karkdown"  # default new page file extension when using the new_page task
